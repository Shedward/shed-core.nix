...

{
  ...
  fileSystems."/" =
    { device = "/dev/disk/by-uuid/9718010e-9082-4c33-95d1-6459ecbbd645";
      fsType = "ext4";
    };

  fileSystems."/boot" =
    { device = "/dev/disk/by-uuid/94F7-B890";
      fsType = "vfat";
    };

  swapDevices =
    [ { device = "/dev/disk/by-uuid/2fb96431-ebb4-4923-924a-a93834d52e68"; }
    ];
